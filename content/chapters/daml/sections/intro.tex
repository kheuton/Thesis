...
Recent work on overdose forecasting has suggested a metric termed the \emph{fraction of best possible reach}, or \emph{BPR}~\citep{heutonPredictingSpatiotemporalCounts2022,heutonSpatiotemporalForecastingOpioidrelated2024}. BPR measures a ratio of event counts. The numerator sums over the model's recommended $K$ sites, while the denominator sums over the best possible $K$ selected in hindsight. This type of evaluation has been used in a preregistered trial~\citep{marshallPreventingOverdoseUsing2022} for assessing forecasts of opioid overdoses in Rhode Island, as well as a follow-up feasability study~\citep{allenTranslatingPredictiveAnalytics2023}. BPR is applicable to many where-to-intervene problems beyond public health.
