...
\captionof{figure}[Pareto frontier of best possible reach (BPR) and log likelihood for real-world tasks.]{
    \textbf{Pareto frontier of best possible reach (BPR, x-axis) and log likelihood (LL, y-axis) for real-world tasks}. Higher is better on both axes. Each panel shows how the final models estimated by different training methods score on the test set of a forecasting task defined in Sec.~\ref{sec:results}. 
