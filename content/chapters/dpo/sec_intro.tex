...
\end{itemize}
Our work suggests that common benchmarking tasks may be giving an incomplete picture of the relative performance of decision-aware methods, and that too-limited hyperparameter tuning protocols may be obscuring the strength of two-stage, decision-unaware methods. We hope this spurs greater innovation in benchmarking tasks and deeper understand of the relative strengths and weaknesses in decision-aware learning methods.
