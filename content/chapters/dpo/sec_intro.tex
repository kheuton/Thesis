...
\begin{itemize}[leftmargin=*,noitemsep,topsep=0pt]
    ...
    \item We provide guidance on how practitioners should evaluate decision-aware methods by reconsidering the top-K site selection tasks from \citet{heuton2025decisionaware}. (Fig.~\ref{fig:topK_interpolation_main}).    
